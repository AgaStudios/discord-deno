...
export type MessageComponentsRaw =
	| MessageActionRowComponentsRaw
	| MessageComponentButtonRaw
	| MessageComponentSelectMenuRaw
	| MessageComponentTextInputRaw;
...
export interface MessageComponentSelectMenuRaw {
	type:
		| MessageComponentsType.STRING_SELECT
		| MessageComponentsType.USER_SELECT
		| MessageComponentsType.ROLE_SELECT
		| MessageComponentsType.MENTIONABLE_SELECT
		| MessageComponentsType.CHANNEL_SELECT;
	custom_id: string;
